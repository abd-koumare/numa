...
NUMA_BACKUP_MAX_EXTRACTED_BYTES = int(os.getenv("NUMA_BACKUP_MAX_EXTRACTED_BYTES", f"{1024 ** 4}"))
NUMA_BACKUP_MAX_MEMBERS = int(os.getenv("NUMA_BACKUP_MAX_MEMBERS", "1000000"))
NUMA_BACKUP_MANIFEST_MAX_BYTES = int(os.getenv("NUMA_BACKUP_MANIFEST_MAX_BYTES", f"{32 * 1024 * 1024}"))
...
MAX_UPLOAD_SIZE = int(os.getenv("MAX_UPLOAD_SIZE", f"{25 * 1024 * 1024}"))
