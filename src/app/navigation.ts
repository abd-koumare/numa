...
export const navigation: NavGroup[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Navigation', path: '/administration/navigation', icon: 'settings' },
      { label: 'Utilisateurs', path: '/administration/utilisateurs', icon: 'settings' },
      { label: 'Groupes', path: '/administration/groupes', icon: 'settings' },
      { label: 'Rôles et permissions', path: '/administration/roles', icon: 'settings' },
      { label: 'Listes', path: '/administration/listes', icon: 'mail' },
      { label: 'Règles métier', path: '/administration/regles', icon: 'workflow' },
